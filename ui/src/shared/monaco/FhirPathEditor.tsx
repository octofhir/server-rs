 ...
 */
/** Imperative handle for inserting text / focusing the editor from outside. */
export interface FhirPathEditorHandle {
  /** Insert a Monaco snippet (supports ${1:placeholder}) at the cursor. */
  insertSnippet: (snippet: string) => void;
  focus: () => void;
}

export const FhirPathEditor = forwardRef<FhirPathEditorHandle, FhirPathEditorProps>(
