...
export function AccessPoliciesPage() {
  ...
  const { data, isLoading, isError, error, refetch } = useAccessPolicies({
          ...
          <EmptyState
            ...
            description={
              error instanceof Error
                ? error.message
                : "Something went wrong while loading access policies."
            }
            actions={[
                  ...
                  <div className={classes.policyCell}>
                    ...
                    <div className={classes.policyText}>
                      ...
                      <Text
                        variant="caption-2"
                        color="secondary"
                        className={classes.policyDescription}
                      >
  ...
  switch (type) {
    ...
    case "quickjs":
      return (
        <Badge
          color={view.color}
          leftSection={<CodeIcon width={12} height={12} aria-hidden="true" />}
        >
          {view.label}
        </Badge>
      );
                ...
                {values.engineType === "quickjs" && (
                  <div className={classes.scriptSection}>
                    <Text variant="body-2" className={classes.scriptLabel}>
                      <strong>Policy Script</strong> <span className={classes.requiredMark}>*</span>
                    </Text>
                    <Text variant="caption-2" color="secondary" className={classes.scriptHint}>
                      ...
                      <Code>deny(reason)</Code>, <Code>abstain()</Code>. Press Ctrl+Space for
                      autocomplete.
                    </Text>
