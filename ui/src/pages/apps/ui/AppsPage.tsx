...
import { type AppResource, getAppEndpointDisplay, getAppStatusView } from "@/entities/api-app";
import { getBundleResources } from "@/shared/api/guards";
import { WorkspacePageLayout } from "@/widgets/workspace-page";
import { useApps, useCreateApp, useDeleteApp, useUpdateApp } from "../lib/useApps";
...
export function AppsPage() {
  ...
  return (
    ...
    >
      {isLoading ? (
        ...
        <div className={classes.tablePanel}>
          <EmptyState
            ...
            description={
              error instanceof Error ? error.message : "The application list failed to load."
            }
            actions={[
      ...
      >
        <Text variant="body-2">
          Are you sure you want to delete <strong>{deletingApp?.name ?? "this application"}</strong>
