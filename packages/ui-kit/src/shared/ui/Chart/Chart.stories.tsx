...
export const StackedBar: Story = {
    args: {
        ...
        option: {
            ...
            yAxis: { type: "value" },
            series: [
                { type: "bar", name: "2xx", stack: "total", data: [1820, 2310, 1990, 2840, 3120, 2760, 3380, 3910] },
            ...
            series: [
                {
                    ...
                    symbolSize: 12,
                    data: [
                        [10, 22], [25, 31], [40, 28], [55, 49], [70, 41],
                        [85, 63], [100, 58], [120, 77], [140, 71], [160, 92],
                    ],
                },
            ],
        } satisfies EChartsCoreOption,
...
export const DarkMode: Story = {
    ...
    args: {
        ...
        option: {
            ...
            yAxis: { type: "value" },
            series: [
                { type: "line", name: "Reads", smooth: true, areaStyle: {}, data: [820, 932, 901, 934, 1290, 1330, 1320, 1450] },
                { type: "line", name: "Writes", smooth: true, data: [220, 282, 201, 234, 290, 430, 410, 520] },
            ],
        } satisfies EChartsCoreOption,
    },
};
...
export const SvgRenderer: Story = {
    args: {
        ...
        option: {
            ...
            xAxis: { type: "category", data: MONTHS },
            yAxis: { type: "value" },
            series: [{ type: "bar", name: "SVG", data: [1820, 2310, 1990, 2840, 3120, 2760, 3380, 3910] }],
        } satisfies EChartsCoreOption,
    },
};
